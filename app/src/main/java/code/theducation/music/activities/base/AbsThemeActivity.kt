...
import code.theducation.appthemehelper.util.MaterialDialogsUtil
import code.theducation.appthemehelper.util.VersionUtils
import code.theducation.music.LanguageContextWrapper
import code.theducation.music.R
import code.theducation.music.util.PreferenceUtil
import code.theducation.music.util.Utils
import code.theducation.music.util.theme.ThemeManager
import java.util.*
...
abstract class AbsThemeActivity : ATHToolbarActivity(), Runnable {
    ...
    fun setDrawUnderNavigationBar() {
        Utils.setAllowDrawUnderNavigationBar(window)
    }
