...
import code.theducation.music.repository.RealPlaylistRepository
...
import code.theducation.music.service.download.FileDownloadManager
import code.theducation.music.service.download.FileToDownload
...
object MusicUtil : KoinComponent {
    ...
    fun downloadFile(
        ...
        FileDownloadManager.initDownload(
                context = context,
                fileDownload = FileToDownload(false, song)
        )
    }

    @Throws(IOException::class, Exception::class)
    fun mediaFile(fileName: String, defaultExt: String): File {
        return File(dirPath, "com/theducation/music/$fileName.$defaultExt")
    }
